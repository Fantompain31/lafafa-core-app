...
const IconBed = () => <svg viewBox="0 0 24 24"><path d="M3 7v12"/><path d="M21 12v7"/><path d="M3 13h18"/><path d="M7 13V9a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v4"/><path d="M14 13V9a2 2 0 0 1 2-2h1a4 4 0 0 1 4 4v2"/></svg>
...
const IconChevronLeft = () => <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" fill="none" strokeWidth="1.8" strokeLinecap="round"><polyline points="15 18 9 12 15 6"/></svg>
const IconChevronRight = () => <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" fill="none" strokeWidth="1.8" strokeLinecap="round"><polyline points="9 18 15 12 9 6"/></svg>
const IconDots = () => <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" fill="none" strokeWidth="1.8" strokeLinecap="round"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>
...
export function StayLayout({ stay, children }: { stay: MyStay; children: React.ReactNode }) {
  ...
  const navItems: NavItem[] = [
    ...
    { label: 'Planning', href: `${baseHref}/organisation`, icon: <IconCalendar /> },
    ...
    { label: 'Souvenirs', href: `${baseHref}/souvenirs`, icon: <IconPhoto />, enabled: false },
    { label: 'Paramètres', href: `${baseHref}/settings`, icon: <IconSettings /> },
  ]
  ...
  const currentPage = visibleNavItems.find(i => isActive(i.href))?.label ?? stay.title
      ...
      <div className="app-main">
        ...
        <div className="app-topbar">
          ...
          <span className="app-topbar-meta">
            ...
            {stay.start_date && stay.end_date && ` · ${new Date(stay.start_date).toLocaleDateString('fr-FR', { day: 'numeric', month: 'short' })} – ${new Date(stay.end_date).toLocaleDateString('fr-FR', { day: 'numeric', month: 'short', year: 'numeric' })}`}
          </span>
        </div>
        ...
        <div className="mobile-header">
          ...
          <span style={{ fontSize: '14px', fontWeight: 500, color: '#2c2420' }}>{stay.title}</span>
          <div style={{ width: 30 }} />
        </div>
      ...
      <div className={`mobile-drawer ${drawerOpen ? 'open' : ''}`}>
        ...
        <div className="mobile-drawer-panel">
          <div className="sidebar-top">
            ...
            <button className="sidebar-toggle" onClick={() => setDrawerOpen(false)} aria-label="Fermer">
              <IconX />
            </button>
          </div>
